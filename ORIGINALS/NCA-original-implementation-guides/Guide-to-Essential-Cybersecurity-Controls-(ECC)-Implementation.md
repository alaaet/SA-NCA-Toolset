...
into account the unique requirements of their organization and its environment. The NCA
confirms that this document is only a guide that can be used as an illustrative model and does
not necessarily mean that this is the only method of implementing the ECC, provided that
other methods do not conflict with the requirements of the NCA This document contains
...
organization. However, it is not allowed to exchange or publish this
...
FIGURE 1 ECC DOMAINS AND SUBDOMAINS ........................................................................................................... 8
...
developed this guide for implementing the Essential Cybersecurity Controls (ECC 1: 2018),
...
implementing the necessary and applicable ECC requirements that are needed for their
...
authorities, establishments, and others) and their companies and entities, as well as private
...
3-1
 ...
 يناربيسلا نملأا ةيجيتارتسا
Cybersecurity Strategy

 يناربيسلا نملأا تاءارجإو تاسايس
Cybersecurity Policies and Procedures

 يناربيسلا نملأا رطاخم ةرادإ
Cybersecurity Risk Management

 نملأا ريياعمو تاميظنتو تاعيرشتب مازتللاا
 يناربيسلا
...
1-8
 ...
 ةيرشبلا دراوملاب قلعتملا يناربيسلا نملأا
...
Asset Management
 ...
 تامولعملا ةجلاعم ةزهجأو ةمظنلأا ةيامح
...
تامولعملاو تانايبلا ةيامح
Data and Information Protection

ةيطايتحلاا خسنلا ةرادإ
Backup and Recovery Management

قارتخلاا رابتخا
Penetration Testing

 يناربيسلا نملأا تاديدهتو ثداوح ةرادإ
...
2-14
 ...
 يناربيسلا نملأا ةرادإ
Cybersecurity Management

 يناربيسلا نملأا تايلوؤسمو راودأ
Cybersecurity Roles and
Responsibilities

 عيراشملا ةرادإ نمض يناربيسلا نملأا
 ةينقتلاو ةيتامولعملا
Cybersecurity in Information
Technology Projects

 يناربيسلا نملأل يرودلا قيقدتلاو ةعجارملا
Periodical Cybersecurity Review and
Audit

 يناربيسلا نملأاب بيردتلاو ةيعوتلا جمانرب
Cybersecurity Awareness and Training
Program

 تايحلاصلاو لوخدلا تايوه ةرادإ
Identity and Access Management

ينورتكللإا ديربلا ةيامح
Email Protection

 ةلومحملا ةزهجلأا نمأ
...
Vulnerability Management
 ...
 يناربيسلا نملأا ةبقارمو ثادحلأا تلاجس ةرادإ
...
Web Application Security
 ...
 لامعلأا ةيرارمتسا ةرادإ يف يناربيسلا نملأا دومص بناوج
Cybersecurity Resilience Aspects of Business Continuity Management (BCM)

4-1

 ةيجراخلا فارطلأاب قلعتملا يناربيسلا نملأا
Third-Party Cybersecurity

4-2

 ةيباحسلا ةبسوحلاب قلعتملا يناربيسلا نملأا
 ةفاضتسلااو
...
2
 ...
 يناربيسلا نملأا زيزعت
Cybersecurity Defense

 يناربيسلا نملأا دومص
Cybersecurity Resilience

 قلعتملا يناربيسلا نملأا
 ةبسوحلاو ةيجراخلا فارطلأاب
ةيباحسلا
...
5
 ...
 مكحتلا ةمظنلأ يناربيسلا نملأا
يعانصلا
ICS Cybersecurity

5-1

 يعانصلا مكحتلا ةمظنأو ةزهجأ ةيامح
...
To ensure that cybersecurity plans, goals, initiatives and projects are contributing to
compliance with related laws and regulations.

A cybersecurity strategy must be defined, documented and approved. It must be
supported by the head of the organization or his/her delegate (referred to in this
...
o Provide a clear and unified vision and communicate it to all internal
...
The cybersecurity strategy must be reviewed periodically according to planned
...
o In specific intervals according to best practices (to be determined by
the organization and documented with the necessary approval in the
strategy document)

o If there are changes in the relevant laws and regulations (e.g., changes

in cybersecurity requirements applicable to the organization)

o In the event of material changes in the organization

• Document and approve the review procedures and changes to the

cybersecurity strategy by the representative.

Expected deliverables

• An approved document that defines the review schedule for the

cybersecurity strategy

• An updated cybersecurity strategy after documenting changes to the
cybersecurity requirements and to be approved by the representative

• Project status reports
• Formal approval by the representative on the updated strategy (e.g., via the

organization's official e-mail, paper or electronic signature)
...
A dedicated cybersecurity function (e.g., division, department) must be established
...
monitoring activities (including compliance monitoring,
operation monitoring, operations, etc.)

o The cybersecurity function is responsible for all cybersecurity
(including defining cybersecurity
...
The position of cybersecurity function head (e.g., CISO), and related supervisory and
...
activities, and providing insights to the organization's leadership
regarding effective cybersecurity risk management methods for the
organization.

o Supervisory positions within the cybersecurity

function (e.g.,
managers of departments and functions within the cybersecurity
function as per the organizational structure and/or the cybersecurity
function governance and operating model approved by
the
...
operations of the function or department until the supervisory
position is filled as per an approved timeline.
o Critical roles within the cybersecurity

include
responsibilities requiring confidentiality and integrity where if not
performed as required, it would have negative impacts on the
...
Workforce Framework (SCyWF) can be utilized as reference
...
A cybersecurity steering committee must be established by the Authorizing Official
...
the organization's head or his/ her deputy, taking into account non-conflict
of interests
...
the cybersecurity of the organization. Such members include but are not
...
addition, define the duties and responsibilities of the supervisory committee
...
up on the implementation of cybersecurity programs and regulations in the
...
organization, managing cybersecurity risks, and submitting meeting minutes
...
• Ensure that the cybersecurity strategy is aligned with the organization's

strategy on a regular basis

Expected deliverables

• Supervisory committee charter in the organization. The charter clarifies the
date of establishment of the committee and its reference and its approval by
the organization's representative

• A documented and approved list showing the names of the organization's

cybersecurity supervisory committee members

• Cybersecurity supervisory committee's agenda in the organization
• Minutes of meetings held for the cybersecurity supervisory committee at the
...
Cybersecurity policies and procedures must be defined and documented by the
...
be done through the approved communication channels as per the scope
...
The cybersecurity function must ensure that the cybersecurity policies and procedures
are implemented.
...
periodically to ensure the full and effective
implementation of all
requirements

• The cybersecurity function must ensure the implementation of cybersecurity
...
The cybersecurity policies and procedures must be supported by technical security
...
security standard controls, network devices, databases, server operating
systems, BYOD operating
standard,
...
The cybersecurity policies and procedures must be reviewed periodically according to
...
• An approved document that clarifies the review of cybersecurity policies,
procedures and standard controls in the organization on a periodic basis
based on the period of time set for review

• Policies, procedures, and standard controls documents indicating that they
have been reviewed and updated, and that changes have been documented
and approved by the representative

• Official approval and approval by the representative on updated policies,

procedures, and standard controls
...
Cybersecurity organizational structure and related roles and responsibilities must be
...
the organization of their responsibilities in implementing cybersecurity
programs and requirements

• Support the organizational structure, roles, and responsibilities of the
organization by the executive management This must be done through the
...
o Roles and responsibilities related to the cybersecurity function (e.g.,
...
assess vulnerabilities, manage access, develop and
implement
cybersecurity awareness programs, etc.)

o Roles and responsibilities related
...
The cybersecurity roles and responsibilities must be reviewed periodically according
...
to cybersecurity roles and responsibilities and approve them by the
representative
...
• An approved document that defines the review schedule for the roles and

responsibilities

• Roles and responsibilities document indicating that they are up to date and
the changes to the cybersecurity requirements for roles and responsibilities
have been documented and approved by the representative
...
Cybersecurity risk management methodology and procedures must be defined,
...
The cybersecurity risk management methodology and procedures must be
...
The cybersecurity risk assessment procedures must be implemented at least in the
following cases:
...
confidentiality, integrity, and availability of information and technology
...
• Remediate all cybersecurity risks
...
cybersecurity risks throughout the technical project
organization
...
• Implement cybersecurity risk assessment procedures when planning to
...
technology assets, including, in particular, the identification of information
and technology assets in technology projects, potential exposure to threats,
...
• Include cybersecurity requirements within
...
The cybersecurity risk management methodology and procedures must be reviewed
...
procedures and cybersecurity risk management requirements
in the
organization periodically according to a documented and approved plan for
...
• Document the review and changes to the cybersecurity requirements related
to cybersecurity risk management methodology and procedures and approve
...
Cybersecurity requirements must be included in project and asset (information/
...
The cybersecurity requirements in project and assets (information/technology)
...
• Cybersecurity Requirements Checklist Template
...
The cybersecurity requirements related to software and application development
...
Using trusted and licensed sources for software development tools and
libraries.
...
requirements of the organizations, such as penetration testing, to ensure that
...
o Secure Configuration and Hardening of information and technology
...
in project management must be reviewed
...
• Evidence that the periodic review of cybersecurity requirements in project
management and changes to the information and technology assets of the
...
The organization must comply with related national cybersecurity laws and
regulations.
...
to verify compliance with national
national
cybersecurity laws and regulations to be submitted to the National
...
• A document (such as a policy, procedure, or/and letter approved by the
authorization official) indicating the identification and documentation of the
requirements related to this control

• An updated list that clarifies the national cybersecurity laws and regulations

Cybersecurity Authority (NCA).

• A report that

cybersecurity laws and regulations applicable to the organization
...
• Work with the organization's stakeholders to identify, document, approve and
periodically update the list of international cybersecurity agreements or
obligations, and periodically document and update them, subject to prior
approval by the National Cybersecurity Authority

• Ensure compliance with all cybersecurity national laws and regulations
requirements approved by the National Cybersecurity Authority within the
organization

• Provide necessary technologies to verify compliance with the laws and
...
• A document (such as approved policy or procedure) indicating the
identification and documentation of the requirements related to this control
• An updated list of locally approved international agreements and obligations

applicable to cybersecurity function

• A report that outlines the extent of compliance with cybersecurity
international agreements and obligations applicable to the organization
...
Cybersecurity reviews must be conducted periodically by the cybersecurity function
...
Cybersecurity audits and reviews must be conducted by independent parties outside
...
implementation of all cybersecurity
the
...
Results from the cybersecurity audits and reviews must be documented and presented
...
• Review and document results of cybersecurity review and audit. The review
...
• Share and discuss the results of cybersecurity review and audit with the

cybersecurity supervisory committee and the representative

Expected deliverables

• A document (such as approved policy or procedure) indicating the
identification and documentation of the requirements related to this control
• Audit reports (by the internal audit department or compliance department or
an independent external auditor) on all cybersecurity requirements of the
organization

• Evidence that the results of the cybersecurity review and audit presented to

the cybersecurity supervisory committee and the representative
...
Personnel cybersecurity requirements (prior to employment, during employment and
...
• Define and document personnel cybersecurity requirements

in the

cybersecurity requirements document and approved by the representative
...
employees during the employee's lifecycle in the organization, including the
...
The personnel cybersecurity requirements prior to employment must include at least
the following:
...
Screening or vetting candidates of cybersecurity and critical/privileged
positions.
...
The personnel cybersecurity requirements during employment must include at least
the following:
1-9-4-1
...
Personnel access to information and technology assets must be reviewed and removed
...
• Review access of employees and revoke
...
o Define professional end-of-service or
covering cybersecurity requirements

termination procedures

o Ensure the return of all organization's assets and revoke employees'
access rights immediately upon the end of their relationship with the
organization

Expected deliverables

• A discharge form with a signed and approved sample for the implementation
...
• Review and update the cybersecurity policy and requirements for personnel
in the organization periodically according to a documented and approved
plan for review and based on a planned interval (e.g., review must be
conducted annually) or in the event of changes in related laws and
regulations Document the review and changes to the cybersecurity
requirements for personnel in the organization and approve them by the head
...
requirements for personnel have been documented and approved by the head
of the organization or his/her deputy
...
A cybersecurity awareness program must be developed and approved. The program
...
• Develop and approve cybersecurity awareness program and plan in the
...
The cybersecurity awareness program must cover the latest cyber threats and how to
...
Essential and customized (i.e., tailored to job functions as it relates to cybersecurity)
...
programs, applications, and employees operating
information and technology assets
...
The implementation of the cybersecurity awareness program must be reviewed
periodically.
...
o Requirements for the defined stages of the information and technology
assets life cycle (including but not limited to: preservation, processing,
storage, destruction, etc.) must be defined
o Roles and responsibilities requirements
...
the organization's developed requirements by

the Executive

Management This must be done through the approval of the representative
...
The cybersecurity requirements for managing information and technology assets must
be implemented.
...
2-1-3
 ...
 Acceptable use policy of information and technology assets must be defined,
...
o These requirements must be communicated through the organization's
...
• Work with the concerned departments to ensure that assets are handled
...
information and technology assets (Labelling) in accordance with the relevant
laws and regulations.
...
assets management in the organization periodically according to a documented
and approved plan for review and based on a planned interval or in the event
of changes in relevant laws and regulations.

• Document and approve review and changes to the organization's cybersecurity
requirements of the information and technology assets management by the head
of the organization or his/ her deputy

Expected deliverables:

• Results of information and technology assets management cybersecurity
...
review cycle to manage the information and technology assets of the
organization (Compliance Assessment Schedule)

• Log of updates and changes to the information and technology asset

management cybersecurity requirements

• Compliance assessment report that outlines the results of the cybersecurity
requirements implementation assessment for information and technology asset
management
...
Cybersecurity requirements for identity and access management must be defined,
documented and approved.
...
• Develop and document cybersecurity policy
...
The cybersecurity requirements for identity and access management must be
implemented.
...
o User authorization management based on
...
The cybersecurity requirements for identity and access management must include at
least the following
...
• Prepare password standard controls taking into consideration best practices,
...
User authorization based on identity and access control principles: Need-to-
...
disabled These copies must be used to configure desktops and servers.
...
The Implementation of the cybersecurity requirements for identity and access
...
The cybersecurity requirements for protecting information systems and information
...
o Scope of devices to be protected and reviewed periodically must be
...
Advanced, up-to-date and secure management of malware and virus
...
o Follow up on the protection system periodically to ensure updates are
...
• A document (such as approved policy or procedure)
...
o Patches procedures must be

in change management
methodology or change management must be included into patch
management policy.
...
not limited to: requesting approvals via e-mail, paper, or through an
internal system.
...
Centralized clock synchronization with an accurate and trusted source (e.g.,
...
• Evidence that the periodic review of security requirements is performed to
protect information systems and processing facilities in the organization.
• Formal approval by the head of the organization or his/her deputy on the
updated requirements (e.g., via the organization's official e-mail, paper or
electronic signature).
...
Cybersecurity requirements for protecting email service must be defined, documented
and approved.
...
The cybersecurity requirements for protecting the email service must include at the
least the following:
...
Analyzing and filtering email messages (specifically phishing emails and
...
Multi-factor authentication for remote and webmail access to email service.
...
Secure management and protection against Advanced Persistent Threats
...
email message if it is not blocked by the protection system, and factors and
...
• Review and update Cybersecurity requirements for email protection in the
...
• Results of email protection cybersecurity requirements implementation review

in the organization

• A document that defines the cybersecurity requirements application review
cycle for the organization's email protection (Compliance Assessment
Schedule).
...
Cybersecurity requirements for network security management must be defined,
documented and approved.
...
o Isolate the production environment network from the development and
...
o Use advanced protection systems to detect and prevent intrusions in the
...
requirements adopted for the organization's network security management in
accordance with the relevant laws and regulations.
...
The cybersecurity requirements for network security management must include at least
the following:

2-5-3-1

Logical or physical segregation and segmentation of network segments using
...
• Define necessary procedures to ensure the physical or logical isolation and
...
segregation between production,
...
requirements of network security management at the organization and must be
approved by the representative.
• Network domains must be

to clarify production
...
are isolated from development and testing environment networks through the
...
clarifies the isolation between the production environment network from the
...
• Define necessary procedures to ensure navigation and internet connection
...
• Conduct of a thorough study of the risks arising from connecting wireless
...
o Sample showing the implementation of wireless network security and
...
and study, including but not limited to, providing a thorough report that
...
o Procedures for managing ports, protocols, network services and access
...
• Regularly review and update of protection systems' configuration, including
...
ensure that no update or change is made without the approval of the
representative.
...
or through Excel Sheet. This is in addition to supporting the review by
...
• Sample showing the implementation of the requirements related to Internet
...
The cybersecurity requirements for network security management must be reviewed
periodically.
...
• Review and update cybersecurity requirements
...
• Results of network security cybersecurity requirements implementation review
...
Cybersecurity requirements for mobile devices security and BYOD must be defined,
documented and approved.
...
isolation, segregation, and cryptography of data and
...
o Provide us of workstations and mobile devices with privileged access
...
o Centrally manage workstations and mobile devices through, but not
...
The cybersecurity requirements for mobile devices security and BYOD must include at
least the following:
...
requirements of the organization's business interest. These requirements may
include the following:
...
information stored on mobile devices and BYOD devices (e.g., a screenshot
...
users (e.g., presentation showing security awareness to the organization's
...
• Results of mobile devices and BYOD cybersecurity
...
Cybersecurity requirements for protecting and handling data and information must be
...
The cybersecurity requirements for protecting and handling data and information must
be implemented.
...
information and document their ownership
(information assets records).

• Implement cybersecurity requirements for data and information ownership to
...
Data and information classification and labeling mechanisms.
...
• Document the review and changes to the cybersecurity requirements for data
and information protection in the organization and approve them by the head
of the organization or his/her deputy.

Expected deliverables:

• Results of data and information protection cybersecurity requirements

implementation review in the organization.

• A document that defines the cybersecurity requirements implementation
review cycle for the organization's data and information security (Compliance
Assessment Schedule).
...
• An approved document that sets the policy's review schedule
• Policy indicating that it is up to date and the changes to the cybersecurity
requirements for data and information protection have been documented and
approved by the head of the organization or his/her deputy.
...
Cybersecurity requirements for cryptography must be defined, documented and
approved.
...
• Develop and document cybersecurity policy for cryptography
...
Approved cryptographic solutions standard controls and its technical and
...
• Results of cryptography requirements
...
• A document that defines the cybersecurity requirements implementation
review cycle for cryptography in the organization (Compliance Assessment
Schedule).
...
• An approved document that sets the policy's review schedule
• Policy indicating that it is up to date and the changes to the cybersecurity
requirements for cryptography have been documented and approved by the
head of the organization or his/her deputy.
...
Cybersecurity requirements for backup and recovery management must be defined,
documented and approved.
...
inspection of backup recovery effectiveness must be
...
The cybersecurity requirements for backup and recovery management must include
at least the following:

2-9-3-1

Scope and coverage of backups to cover critical technology and information
assets.
...
• Implement backup to all critical information and technology assets in the
...
Ability to perform quick recovery of data and systems after cybersecurity
incidents.
...
• Plan for periodic inspection of backup recovery effectiveness must be
...
• A document that defines the cybersecurity requirements application review
cycle for backup management at the organization (Compliance Assessment
Schedule).
...
• An approved document that sets the policy's review schedule
• Policy indicating that it is up to date and the changes to the cybersecurity
requirements for Backup and Recovery Management have been documented
...
Cybersecurity requirements for technical vulnerabilities management must be defined,
documented and approved.
...
The cybersecurity requirements for technical vulnerabilities management must be
implemented.
...
The cybersecurity requirements for technical vulnerabilities management must
include at least the following:
...
• Vulnerabilities management procedures that
...
Vulnerabilities remediation based on classification and associated risk
levels.
...
• Link vulnerabilities management procedures
...
• Cybersecurity policy and procedures that cover the security patch
...
Subscription with authorized and trusted cybersecurity resources for up-
...
• A document that defines the cybersecurity requirements implementation
review cycle for vulnerabilities management in the organization (Compliance
Assessment Schedule).
...
Cybersecurity requirements for penetration testing exercises must be defined,
documented and approved.
...
The cybersecurity requirements for penetration testing processes must include at least
the following:

2-11-3-1

Scope of penetration tests which must cover Internet-facing services and
its
infrastructure, websites, web
...
• Identify all technical components that support these external services,
...
• Develop and implement an action plan for penetration testing, including the
...
Cybersecurity requirements for penetration testing processes must be reviewed
periodically.
...
• Results of penetration testing cybersecurity requirements implementation
...
The cybersecurity requirements for event logs and monitoring management must be
implemented.
...
12 months) and identify this item in contracts and agreements if the
...
The cybersecurity requirements for event logs and monitoring management must
include at least the following:
...
Activation of cybersecurity event logs on remote access and privileged user
accounts.
...
Identification of required technologies (e.g., SIEM) for cybersecurity event
logs collection.
...
• Connect all the organization's critical devices and systems, including those
...
that all the aforementioned scope and any systems and devices found in the
...
• If an external service is contracted for monitoring, the access location of the
...
Retention period for cybersecurity event logs (must be 12 months
minimum).
...
• A sample of stored logs extracted from the SIEM system where records have
...
• Review and update cybersecurity requirements for Cybersecurity Event Logs
...
Requirements for cybersecurity incidents and threat management must be defined,
documented and approved.
...
The requirements for cybersecurity incidents and threat management must be
implemented.
...
The requirements for cybersecurity incidents and threat management must include at
least the following:
...
required, and entities that should be involved in response
activities.
...
• Develop cybersecurity incident report upon completion of the response
...
is@nca.gov.sa , and follow up on any updates and
incident reporting
...
Sharing incidents notifications, threat intelligence, breach indicators and
reports with NCA.
...
that the Authority may issue on reporting alerts, threat intelligence, and
...
• Sample of a cybersecurity incident report sent to NCA (including but not
...
• Review and update cybersecurity requirements for cybersecurity incident and
in the organization periodically according to a
threat management
documented and approved plan for review and based on a planned interval or
in the event of changes in relevant laws and regulations.
...
To ensure the protection of information and technology assets from unauthorized
...
Cybersecurity requirements for physical protection of information and technology
...
o Security of devices and equipment
...
The cybersecurity requirements for physical protection of information and technology
...
vandalism
in the protection procedures to ensure compliance with
...
o Documented and approved procedures for the security of devices and
...
Secure destruction and re-use of physical assets that hold classified
...
• Develop methodology and procedures for the reuse of physical assets
...
• Utilize technical solutions and equipment protection programs inside and
...
the
organization's
technology assets protection against
...
theft and vandalism by the cybersecurity function and in cooperation with
...
in the organization (Compliance Assessment
implementation review
Schedule).
...
• A compliance assessment report that shows the assessment of the
implementation of cybersecurity requirements
information and
technology assets protection against unauthorized physical access, loss, theft,
and vandalism
...
Cybersecurity requirements for external web applications must be defined,
documented and approved.
...
The cybersecurity requirements for external web applications must include at least the
following:
...
standard controls including the use of a web application firewall
system.
...
o Identify relevant departments
...
application development lifecycle to ensure the protection of future
applications.
...
The cybersecurity requirements for external web applications must be reviewed
periodically.
...
• a document that defines the cybersecurity requirements application review
the organization's external web applications (Compliance
...
Cybersecurity requirements for business continuity management must be defined,
documented and approved.
...
the continuity of cybersecurity-related systems and
...
The cybersecurity requirements for business continuity management must be
implemented.
...
The cybersecurity requirements for business continuity management must include
at least the following:
...
o Cybersecurity-related systems continuity procedures,
...
Developing response plans for cybersecurity incidents that may affect the
business continuity.
...
• Identify the requirements of periodic copies of the organization's systems to
...
Cybersecurity requirements for contracts and agreements with third-parties must be
...
The cybersecurity requirements for contracts and agreements with third-parties (e.g.,
Service Level Agreement (SLA)) -
or services- must include at least the following:

4-1-2-1

Non-disclosure clauses and secure
...
organization, including communication means and data in the event of a
...
organization's cybersecurity requirements and policies and the relevant laws
and regulations.
...
The cybersecurity requirements for contracts and agreements with IT outsourcing and
...
Cybersecurity managed services centers for monitoring and operations must
...
The cybersecurity requirements for contracts and agreements with third-parties must
be reviewed periodically.
...
The cybersecurity requirements related to the use of hosting and cloud computing
...
In line with related and applicable laws and regulations, and in addition to the
...
Classification of data prior to hosting on cloud or hosting services and
...
environment is separated from other entities' environments in cloud
computing services.
...
Cybersecurity requirements related to Industrial Controls Systems and Operational
...
to ensure compliance with cybersecurity
...
In addition to the applicable ECC controls from the main domains (1), (2), (3) and (4),
the cybersecurity requirements related to Industrial Controls Systems and Operational
...
Continuous monitoring and activation of cybersecurity event logs on the
...
Strict limitation on connecting mobile devices to industrial production
networks.
...
• Ensure that the mobile devices' connectivity to the industrial production
...
limited to, requesting approvals via e-mail, paper, or through an internal
system). Such procedures include:
...
Periodic review and secure configuration and hardening of industrial,
...
in cooperation with system providers and
...
systems, support systems, and industrial machinery, indicating their periodic
application.

5-1-3-8

Vulnerability management for industrial control systems and operational
technology (ICS/OT).
...
industrial control systems and operational
...
• Develop approved procedures and plans for the management of patches for
...
Cybersecurity applications management related to the protection of the
...
• Implement and develop antivirus and malware protection tools for industrial
...
• Reports on the update of protection against viruses, suspicious malware and
