...
[Introduction 4](#_Toc120738359)

[Mandate 4](#_Toc120738360)

[Purpose 4](#_Toc120738361)

[Scope 4](#_Toc120738362)

[Controls 5](#_Toc120738363)

[Composition 6](#_Toc120738364)

[General Rules 8](#_Toc120738365)

[Roles and Responsibilities 10](#_Toc120738366)

[Update and Review 10](#_Toc120738367)

[Compliance 10](#_Toc120738368)
...
# [Mandate](#_Mandate" \o "يُوضّح هذا القسم التكليف الخاص باللجنة الإشرافية للأمن السيبراني، وهو مجرد مثال ويُمكن تعديله على النحو المناسب الذي تراه الجهة بشرط أن تلتزم بالضابط ECC 1-2-3)
...
# [Composition](#_Composition" \o "يُوضّح هذا القسم تشكيل اللجنة الخاصة باللجنة الإشرافية للأمن السيبراني، وهو مجرد مثال ويُمكن تعديله على النحو المناسب الذي تراه الجهة بشرط أن تلتزم بالضابط ECC 1-2-3)
...
2. CSC includes permanent members, as well as guest members (that attend on an as-needed basis). CSC must include members affected or members whose business is affected by <organization name>’s cybersecurity. Such members include without limitation:
 1. <organization head or deputy>
 2. <head of cybersecurity function>
 3. <head information technology function>
 4. <head of risk function>
 5. <head of compliance function>
 6. <head of business function>
 7. <head of human resources function>
 8. <head of safety and security function>
...
# [General Rules](#_Operating_Principles" \o "يُوضّح هذا القسم الضوابط الخاصة بأعضاء اللجنة الإشرافية للأمن السيبراني والتي يجب الالتزام بها، وهي مجرد مثال ويُمكن تعديلها على النحو المناسب الذي تراه الجهة)
...
6. Information among CSC members is shared using a traffic light protocol (TLP) in order to enable secure information governance. All information shared in CSC must be classified and clearly marked in accordance with the following color-coded levels:
 1. Information classified as **RED** can only be discussed by the members of CSC.
 2. Information classified as **AMBER** can be shared by CSC members with their direct reports on a need-to-know basis to address the specific topic or risk.
 3. Information classified as **GREEN** is internal information that can be shared with all employees of the <organization name>.

# [Roles](#_الأدوار_والمسؤوليات) and Responsibilities
